...
define void @sum_kernel(ptr %0, ptr %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6, i32 %7) local_unnamed_addr #0 !dbg !3 {
  ...
  %82 = load <128 x float>, ptr %81, align 4, !dbg !10
  %83 = extractelement <128 x i64> %73, i64 0, !dbg !10
  %84 = inttoptr i64 %83 to ptr, !dbg !10
  %85 = load <128 x float>, ptr %84, align 4, !dbg !10
  %86 = extractelement <128 x i64> %74, i64 0, !dbg !10
  %87 = inttoptr i64 %86 to ptr, !dbg !10
  %88 = load <128 x float>, ptr %87, align 4, !dbg !10
  %89 = extractelement <128 x i64> %75, i64 0, !dbg !10
  %90 = inttoptr i64 %89 to ptr, !dbg !10
  %91 = load <128 x float>, ptr %90, align 4, !dbg !10
  %92 = extractelement <128 x i64> %76, i64 0, !dbg !10
  %93 = inttoptr i64 %92 to ptr, !dbg !10
  %94 = load <128 x float>, ptr %93, align 4, !dbg !10
  %95 = extractelement <128 x i64> %77, i64 0, !dbg !10
  %96 = inttoptr i64 %95 to ptr, !dbg !10
  %97 = load <128 x float>, ptr %96, align 4, !dbg !10
  %98 = extractelement <128 x i64> %78, i64 0, !dbg !10
  %99 = inttoptr i64 %98 to ptr, !dbg !10
  %100 = load <128 x float>, ptr %99, align 4, !dbg !10
  %101 = extractelement <128 x i64> %79, i64 0, !dbg !10
  %102 = inttoptr i64 %101 to ptr, !dbg !10
  %103 = load <128 x float>, ptr %102, align 4, !dbg !10
  %104 = tail call float @llvm.vector.reduce.fadd.v128f32(float 0.000000e+00, <128 x float> %82), !dbg !11
  %105 = insertelement <8 x float> poison, float %104, i64 0, !dbg !11
  %106 = tail call float @llvm.vector.reduce.fadd.v128f32(float 0.000000e+00, <128 x float> %85), !dbg !11
  %107 = insertelement <8 x float> %105, float %106, i64 1, !dbg !11
  %108 = tail call float @llvm.vector.reduce.fadd.v128f32(float 0.000000e+00, <128 x float> %88), !dbg !11
  %109 = insertelement <8 x float> %107, float %108, i64 2, !dbg !11
  %110 = tail call float @llvm.vector.reduce.fadd.v128f32(float 0.000000e+00, <128 x float> %91), !dbg !11
  %111 = insertelement <8 x float> %109, float %110, i64 3, !dbg !11
  %112 = tail call float @llvm.vector.reduce.fadd.v128f32(float 0.000000e+00, <128 x float> %94), !dbg !11
  %113 = insertelement <8 x float> %111, float %112, i64 4, !dbg !11
  %114 = tail call float @llvm.vector.reduce.fadd.v128f32(float 0.000000e+00, <128 x float> %97), !dbg !11
  %115 = insertelement <8 x float> %113, float %114, i64 5, !dbg !11
  %116 = tail call float @llvm.vector.reduce.fadd.v128f32(float 0.000000e+00, <128 x float> %100), !dbg !11
  %117 = insertelement <8 x float> %115, float %116, i64 6, !dbg !11
  %118 = tail call float @llvm.vector.reduce.fadd.v128f32(float 0.000000e+00, <128 x float> %103), !dbg !11
...
Lnames_begin:
	...
	.long	0
	.long	1831661754
.set Lset1360, LNames0-Lnames_begin
	.long	Lset1360
LNames0:
	.long	81
	.long	2
