...
define void @sum_kernel(ptr nocapture writeonly %0, ptr nocapture readonly %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6) local_unnamed_addr #0 !dbg !3 {
  ...
  %12 = tail call half @llvm.vector.reduce.fadd.v128f16(half 0xH0000, <128 x half> %11), !dbg !9
  %13 = sext i32 %4 to i64, !dbg !13
  %14 = getelementptr half, ptr %0, i64 %13, !dbg !13
  store half %12, ptr %14, align 2, !dbg !14
  ret void, !dbg !15
}
...
Lnames_begin:
	...
	.long	0
	.long	1831661754
.set Lset230, LNames0-Lnames_begin
	.long	Lset230
LNames0:
	.long	78
	.long	2
