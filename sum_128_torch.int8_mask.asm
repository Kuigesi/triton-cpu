...
define void @sum_kernel(ptr nocapture writeonly %0, ptr nocapture readonly %1, i32 %2, i32 %3, i32 %4, i32 %5, i32 %6) local_unnamed_addr #0 !dbg !3 {
  ...
  %15 = tail call i8 @llvm.vector.reduce.add.v128i8(<128 x i8> %14), !dbg !10
  %16 = sext i32 %4 to i64, !dbg !14
  %17 = getelementptr i8, ptr %0, i64 %16, !dbg !14
  store i8 %15, ptr %17, align 1, !dbg !15
  ret void, !dbg !16
}
...
LBB0_86:
	...
	.loc	1 17 0
	ldr	q21, [x12, lCPI0_9@PAGEOFF]
	ldr	q22, [x13, lCPI0_10@PAGEOFF]
	adrp	x14, lCPI0_5@PAGE
	adrp	x13, lCPI0_6@PAGE
	ldr	q25, [x11, lCPI0_11@PAGEOFF]
	adrp	x12, lCPI0_7@PAGE
	adrp	x11, lCPI0_8@PAGE
	ldr	q28, [x1, lCPI0_12@PAGEOFF]
	ldr	q26, [x2, lCPI0_13@PAGEOFF]
	ldr	q27, [x3, lCPI0_14@PAGEOFF]
	ldr	q23, [x5, lCPI0_15@PAGEOFF]
	ldr	q24, [x6, lCPI0_16@PAGEOFF]
	.loc	1 17 22
	tbz	x9, #50, LBB0_88
	add	x1, x8, #50
	ld1.b	{ v3 }[2], [x1]
LBB0_88:
	...
	.cfi_offset b9, -16
	.loc	1 17 0
	ldr	q18, [x15, lCPI0_0@PAGEOFF]
	ldr	q19, [x16, lCPI0_1@PAGEOFF]
	ldr	q20, [x17, lCPI0_2@PAGEOFF]
	cmgt.4s	v21, v17, v21
	ldr	q29, [x10, lCPI0_3@PAGEOFF]
	cmgt.4s	v22, v17, v22
	cmgt.4s	v25, v17, v25
	ldr	q30, [x14, lCPI0_5@PAGEOFF]
	cmgt.4s	v28, v17, v28
	ldr	q31, [x13, lCPI0_6@PAGEOFF]
	cmgt.4s	v26, v17, v26
	cmgt.4s	v27, v17, v27
	ldr	q8, [x12, lCPI0_7@PAGEOFF]
	cmgt.4s	v23, v17, v23
	cmgt.4s	v24, v17, v24
	ldr	q9, [x11, lCPI0_8@PAGEOFF]
	.loc	1 17 22
	tbz	x9, #51, LBB0_90
	add	x10, x8, #51
	ld1.b	{ v3 }[3], [x10]
...
LBB0_92:
	...
	uzp1.8h	v20, v31, v30
	uzp1.8h	v24, v17, v8
	uzp1.16b	v21, v22, v21
	uzp1.16b	v22, v23, v25
	.loc	1 17 22 epilogue_begin
	ldp	d9, d8, [sp, #16]
	add	sp, sp, #32
	tbnz	x9, #53, LBB0_183
	.loc	1 17 0
	uzp1.16b	v17, v19, v18
	uzp1.16b	v20, v24, v20
	and.16b	v18, v21, v16
	and.16b	v19, v22, v16
	.loc	1 17 22
	tbnz	x9, #54, LBB0_184
LBB0_94:
	...
	and.16b	v17, v17, v16
	and.16b	v16, v20, v16
	ext.16b	v22, v18, v18, #8
	ext.16b	v23, v19, v19, #8
	.loc	1 17 22
	tbnz	x9, #55, LBB0_185
LBB0_95:
	.loc	1 17 0
	ext.16b	v20, v17, v17, #8
	ext.16b	v21, v16, v16, #8
	zip1.16b	v18, v18, v22
	zip1.16b	v19, v19, v23
	.loc	1 17 22
	tbnz	x9, #56, LBB0_186
LBB0_96:
	.loc	1 17 0
	zip1.16b	v17, v17, v20
	zip1.16b	v20, v16, v21
	addv.8h	h18, v18
	addv.8h	h19, v19
	.loc	1 17 22
	tbnz	x9, #57, LBB0_187
...
LBB0_112:
	tbnz	w10, #9, LBB0_203
LBB0_113:
	tbnz	w10, #10, LBB0_204
LBB0_114:
	tbnz	w10, #11, LBB0_205
LBB0_115:
	tbnz	w10, #12, LBB0_206
LBB0_116:
	tbnz	w10, #13, LBB0_207
LBB0_117:
	tbnz	w10, #14, LBB0_208
LBB0_118:
	tbnz	w10, #15, LBB0_209
LBB0_119:
	tbnz	w10, #16, LBB0_210
LBB0_120:
	tbnz	w10, #17, LBB0_211
LBB0_121:
	tbnz	w10, #18, LBB0_212
LBB0_122:
	tbnz	w10, #19, LBB0_213
LBB0_123:
	tbnz	w10, #20, LBB0_214
LBB0_124:
	tbnz	w10, #21, LBB0_215
LBB0_125:
	tbnz	w10, #22, LBB0_216
LBB0_126:
	tbnz	w10, #23, LBB0_217
LBB0_127:
	tbnz	w10, #24, LBB0_218
LBB0_128:
	tbnz	w10, #25, LBB0_219
LBB0_129:
	tbnz	w10, #26, LBB0_220
LBB0_130:
	tbnz	w10, #27, LBB0_221
LBB0_131:
	tbnz	w10, #28, LBB0_222
LBB0_132:
	tbnz	w10, #29, LBB0_223
LBB0_133:
	tbnz	w10, #30, LBB0_224
LBB0_134:
	tbnz	w10, #31, LBB0_225
LBB0_135:
	tbnz	x10, #32, LBB0_226
LBB0_136:
	tbnz	x10, #33, LBB0_227
LBB0_137:
	tbnz	x10, #34, LBB0_228
LBB0_138:
	tbnz	x10, #35, LBB0_229
LBB0_139:
	tbnz	x10, #36, LBB0_230
LBB0_140:
	tbnz	x10, #37, LBB0_231
LBB0_141:
	tbnz	x10, #38, LBB0_232
LBB0_142:
	tbnz	x10, #39, LBB0_233
LBB0_143:
	tbnz	x10, #40, LBB0_234
LBB0_144:
	tbnz	x10, #41, LBB0_235
LBB0_145:
	tbnz	x10, #42, LBB0_236
LBB0_146:
	tbnz	x10, #43, LBB0_237
LBB0_147:
	tbnz	x10, #44, LBB0_238
LBB0_148:
	tbnz	x10, #45, LBB0_239
LBB0_149:
	tbnz	x10, #46, LBB0_240
LBB0_150:
	tbnz	x10, #47, LBB0_241
LBB0_151:
	tbnz	x10, #48, LBB0_242
LBB0_152:
	tbnz	x10, #49, LBB0_243
LBB0_153:
	tbnz	x10, #50, LBB0_244
LBB0_154:
	tbnz	x10, #51, LBB0_245
LBB0_155:
	tbnz	x10, #52, LBB0_246
LBB0_156:
	tbnz	x10, #53, LBB0_247
LBB0_157:
	tbnz	x10, #54, LBB0_248
LBB0_158:
	tbnz	x10, #55, LBB0_249
LBB0_159:
	tbnz	x10, #56, LBB0_250
LBB0_160:
	tbnz	x10, #57, LBB0_251
LBB0_161:
	tbnz	x10, #58, LBB0_252
LBB0_162:
	tbnz	x10, #59, LBB0_253
LBB0_163:
	tbnz	x10, #60, LBB0_254
LBB0_164:
	tbnz	x10, #61, LBB0_255
LBB0_165:
	tbnz	x10, #62, LBB0_256
LBB0_166:
	tbz	x10, #63, LBB0_168
LBB0_167:
	add	x8, x8, #127
